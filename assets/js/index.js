...
d3.csv("data.csv", function(data) {
  ...
  dimensions = ["smoothness_mean", "compactness_mean", "compactness_mean", "concave points_mean", "symmetry_mean"]
  ...
  for (i in dimensions) {
    ...
    y[name] = d3.scaleLinear()
      .domain( [0,0.35] ) // --> Same axis range for each group
